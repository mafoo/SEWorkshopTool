...
namespace Gwindalmir.Updater
{
    ...
    {
        private const string ROOT_URL = "https://api.github.com/repos/{0}/{1}/";
        private const string AUTHOR = "Gwindalmir";
        private const string PROJECT = "SEWorkshopTool";
        ...
        public Release GetLatestRelease()
        {
            if (m_latest == null)
            {
                var request = new HttpRequestMessage(HttpMethod.Get,
                    m_prereleases
                        ? string.Format(ROOT_URL, m_author, m_project) + "releases?per_page=1&pages=1"
